...
type ReportAutomaticImportOpen = () => void;
type ReportAutomaticImportStepComplete = (params: { step: number }) => void;
type ReportAutomaticImportGenerationComplete = (params: {
...
interface TelemetryContextProps {
  ...
  reportAutomaticImportOpen: ReportAutomaticImportOpen;
  reportAutomaticImportStepComplete: ReportAutomaticImportStepComplete;
  reportGenerationComplete: ReportAutomaticImportGenerationComplete;
  reportAssistantComplete: ReportAutomaticImportComplete;
}
...
export const TelemetryContextProvider = React.memo<PropsWithChildren<{}>>(({ children }) => {
  ...
  const reportAutomaticImportOpen = useCallback<ReportAutomaticImportOpen>(() => {
  ...
  const reportAutomaticImportStepComplete = useCallback<ReportAutomaticImportStepComplete>(
    ({ step }) => {
  ...
  const reportAutomaticImportGenerationComplete = useCallback<ReportAutomaticImportGenerationComplete>(
  ...
  const value = useMemo<TelemetryContextProps>(
    () => ({
      ...
      reportAutomaticImportOpen,
      reportAutomaticImportStepComplete,
      reportAutomaticImportGenerationComplete,
