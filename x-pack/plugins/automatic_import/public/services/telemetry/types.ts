...
export enum TelemetryEventType {
  ...
  AutomaticImportOpen = 'integration_assistant_open',
  AutomaticImportStepComplete = 'integration_assistant_step_complete',
  AutomaticImportGenerationComplete = 'integration_assistant_generation_complete',
  AutomaticImportComplete = 'integration_assistant_complete',
}
